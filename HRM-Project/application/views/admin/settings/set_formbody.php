...
<div class="wrap-fpanel">
    <div class="panel panel-default" data-collapsed="0">
        ...
        <div class="panel-body">
            ...
            <form id="form" action="<?php echo base_url() ?>admin/settings/add_formbody_language/<?php echo $language ?>" method="post" class="form-groups-bordered">
                <?php foreach ($all_formbody_language as $key => $v_formbody_language) : ?>                
