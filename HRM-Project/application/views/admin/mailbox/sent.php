...
<div class="content-wrapper">
    ...
    <section class="content-header ">
        <div class="col-sm-12">
            <span >
                <b style="font-size: 25px;"><?php echo $this->language->form_heading()[8] ?></b>
            </span>        
        </div>
    </section>    
    <!-- Main content -->
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="<?php echo base_url() ?>admin/mailbox/delete_send_mail" >
                                    ...
                                    <tbody>
                                        <?php if (!empty($get_sent_message)):foreach ($get_sent_message as $v_sent_msg): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url() ?>admin/mailbox/read_send_mail/<?php echo $v_sent_msg->send_id ?>"><?php echo $v_sent_msg->to; ?></a></td>
