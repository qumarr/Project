                ...
                $.each(buttonStr.split(' '), function(i) {
                    ...
                    $.each(this.split(','), function(j, buttonName) {
                        if (buttonName == 'title') {
                            ...
                            e.append("<span class='fc-header-title' style='margin-left:180px;'>\n\
                            <div style='font-size: 14px;'>\n\
<span  class='dash-holiday' ></span><span style='margin-right:10px;'>Holiday</span>\n\
<span  class='dash-leave' ></span><span>On Leave</span>\n\
</div>");
                            prevButton = null;
                        } else {
                            var buttonClick;
